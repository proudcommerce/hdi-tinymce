...
$base_url="//".$_SERVER['HTTP_HOST'];  // base url of site (without final /). If you prefer relative urls leave empty
$upload_dir = '/out/wysiwyg/uploads/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../../out/wysiwyg/uploads/'; // relative path from filemanager folder to upload folder (with final /)

//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../../out/wysiwyg/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
